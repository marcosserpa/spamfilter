...
class CSVParser
  #keys = [ :word_freq_make, :word_freq_address, :word_freq_all, :word_freq_3d, :word_freq_our, :word_freq_over, :word_freq_remove, 
  ...
  # TODO read name file from method parameter
